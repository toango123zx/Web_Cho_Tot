				...
				return (
					<>
						...
						<DialogDescription className="text-left text-gray-600 ">
							<div className="text-xl font-semibold text-black">Xác thực tài khoản</div>{' '}
							Để thay đổi email, vui lòng nhập mật khẩu của bạn để xác thực tài khoản{' '}
							{currentPhoneNumber}
						</DialogDescription>
				...
				return (
					<>
						...
						<DialogDescription className="text-center text-gray-600">
							Xác thực email để nhận các thông tin liên quan đến tài khoản cá nhân, thông
							tin giao dịch, chính sách và các ưu đãi mới của Chợ Tốt
						</DialogDescription>
						<div className="grid gap-4 py-4">
							<div className="grid gap-2">
				...
				return (
					<>
						...
						<DialogDescription className="text-center text-gray-600 mb-6">
							...
							<span className="font-semibold">{newEmail || currentEmail}</span>
						</DialogDescription>
