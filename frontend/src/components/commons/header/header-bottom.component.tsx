...
export function HeaderBottom() {
	const [isAccountLayerShown, setIsAccountLayerShown] = useState(true)
	...
	return (
		<div className='flex flex-col sm:flex-row items-center px-4 sm:px-6 py-2 gap-4 sm:gap-0'>
			...
			<div className='relative inline-flex items-center gap-2 sm:gap-3 cursor-pointer group w-full sm:w-auto'>
				...
				<div className='absolute top-full left-0 sm:left-auto w-full sm:w-[250px] md:w-[300px] mt-2 sm:pt-2 hidden group-hover:flex rounded-sm z-10'>
					<div className='flex flex-col bg-white rounded-sm shadow-lg w-full'>
						<div className='inline-flex items-center justify-between bg-white rounded-sm hover:bg-gray-300/70 px-3 sm:px-4 py-2 group/menu'>
						...
						<div className='absolute top-0 sm:left-full w-full sm:w-[250px] md:w-[300px] hidden shadow-lg rounded-sm group-hover/menu:flex'>
							<ul className='flex flex-col bg-white rounded-sm w-full'>
								<div className='inline-flex items-center justify-between bg-white rounded-sm hover:bg-gray-300 px-3 sm:px-4 py-2'>
									<span className='inline-flex items-center gap-2 sm:gap-3'>
			...
			<div className='flex items-center gap-3 sm:gap-6 text-xs sm:text-sm flex-wrap justify-center sm:justify-end'>
				...
				<div className='relative inline-flex items-center gap-1 sm:gap-2 cursor-pointer group'>
					<CircleUserRound
						size={18}
						className='group-hover:opacity-70'
					/>
					<span
						...
						className='group-hover:opacity-70 hidden sm:inline self-stretch'
					>
						Tài khoản
					</span>
					<ChevronDown
					...
					{/* Layer */}
					{isAccountLayerShown && <AccountLayer accountLayerRef={accountLayerRef} />}
				</div>
				<Button
