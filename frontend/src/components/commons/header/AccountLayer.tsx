...
export function AccountLayer({ accountLayerRef, isLoggedIn, username }: AccountLayerProps) {
    ...
    >
      <div className="flex gap-3 p-3">
        ...
        {!isLoggedIn ? (
          <p className="text-lg font-bold inline-flex items-center gap-1">
            <span onClick={handleLoginClick}>Đăng nhập</span> / <span onClick={handleRegisterClick}>Đăng ký</span>
          </p>
        ) : (
            ...
            <p className="inline-flex items-center gap-2">
              ...
              <span className="flex items-center">
                {Array.from({ length: 5 })
                  .fill(0)
                  .map((_, index) => (
                    <Star key={index} fill="currentColor" color="currentColor" size={12} className="text-[#c1c1c0]" />
                  ))}
              </span>
      ...
      <div className="px-3">
        <div className="relative bg-[#306bd9] text-white flex items-center justify-between rounded-lg h-10">
          ...
          />
          <span className="pl-[54px] text-xs font-bold">Nạp Đồng Tốt giá trị linh hoạt</span>
      ...
      {
        <div className="mt-3">
          <div className="px-3 py-2 font-semibold text-gray-500 bg-gray-200">Quản lí đơn hàng</div>
          ...
          <div className="px-3 py-2 font-semibold text-gray-500 bg-gray-200">Tiện ích</div>
          <div className="hover:bg-gray-100 px-3 py-2 flex items-center gap-2">
            <img
          ...
          <div className="px-3 py-2 font-semibold text-gray-500 bg-gray-200">Dịch vụ trả phí</div>
          <div className="hover:bg-gray-100 px-3 py-2 flex items-center gap-2">
          ...
          <div className="hover:bg-gray-100 px-3 py-2 flex items-center gap-2">
            <img src="https://static.chotot.com/storage/icons/svg/setting.svg" className="size-5" alt="settings" />
            <span>Cài đặt tài khoản</span>
          </div>

          <div className="hover:bg-gray-100 px-3 py-2 flex items-center gap-2">
            <img src="https://static.chotot.com/storage/icons/svg/logout.svg" className="size-5" alt="settings" />
            <span>Đăng xuất</span>
          </div>
        </div>
      }
